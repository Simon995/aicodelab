...
MYSQL_NAME = os.getenv('IZONE_MYSQL_NAME', 'aicodelab')
...
DEFAULT_FROM_EMAIL = os.getenv('IZONE_DEFAULT_FROM_EMAIL', 'AICodeLab博客 <your-email-address>')

# 网站默认设置和上下文信息
SITE_LOGO_NAME = os.getenv('IZONE_LOGO_NAME', 'AICodeLab')
SITE_END_TITLE = os.getenv('IZONE_SITE_END_TITLE', '')
SITE_DESCRIPTION = os.getenv('IZONE_SITE_DESCRIPTION', 'AICodeLab是一个使用 Django+Bootstrap4 搭建的个人博客类型网站')
SITE_KEYWORDS = os.getenv('IZONE_SITE_KEYWORDS', 'AICodeLab,Python,TensorFlow,PyTorch,人工智能,机器学习,深度学习,医学影像,Django博客,个人博客')

# 个性化设置，非必要信息
# 个人 Github 地址
MY_GITHUB = os.getenv('IZONE_GITHUB', 'https://github.com/Simon995')
# 工信部备案信息
BEIAN = os.getenv('IZONE_BEIAN', '豫ICP备20020776号')
# 站长统计（友盟）
...
HAO_CONSOLE = {
    ...
    'url': os.getenv('IZONE_HAO_URL', 'https://hao.aicodelab.com')
}